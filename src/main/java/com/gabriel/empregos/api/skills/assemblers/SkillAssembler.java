package com.gabriel.empregos.api.skills.assemblers;
...
import com.gabriel.empregos.api.skills.controllers.SkillRestController;
...
public class SkillAssembler implements SimpleRepresentationModelAssembler<SkillResponse>{
    ...
    public void addLinks(CollectionModel<EntityModel<SkillResponse>> resources) {
        ...
        var createLink = linkTo(methodOn(SkillRestController.class)
            .create(null))
            .withRel("create")
            .withType("POST");
